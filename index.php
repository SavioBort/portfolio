...
<body>
                ...
                <div class="flex flex-1 items-center justify-end sm:items-stretch sm:justify-end">
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-8">
                            ...
                            <a href="#" class="px-5 py-3 text-lg font-medium text-gray-300 border-b-2 border-transparent hover:border-green-500 hover:text-green-500">Contact</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="relative isolate overflow-hidden bg-black py-24 sm:py-32 flex items-center justify-center">
        <div class="absolute top-[20%] flex justify-center w-full">
            <img src="https://avatars.githubusercontent.com/u/118234357?v=4" alt="Profile" class="w-64 h-64 rounded-full border-4 border-green-500 m-2.5">
        </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            ...
            <div class="mt-12">
                <a href="#contact" class="inline-block px-6 py-3 text-base font-semibold text-white bg-green-700 rounded-full hover:bg-green-600">
                    ENTRAR EM CONTATO
                </a>
            </div>
        </div>
    ...
    <section class="relative py-24 sm:py-32 text-center text-white" style="background-color: #121212;">
        <h1 class="absolute top-8 left-1/2 transform -translate-x-1/2 text-xl font-semibold tracking-tight mb-2 text-green-500">
            Portfolio
        </h1>
        <h2 class="absolute top-11 left-1/2 transform -translate-x-1/2 text-3xl font-bold tracking-tight sm:text-4xl mb-8 mt-6 text-lg leading-8 text-white">
            Meus Projetos
        </h2>
        ...
        <form action="https://api.web3forms.com/submit" method="POST" class="w-full max-w-4xl" id="contactForm">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <input id="nome" type="text" name="nome" placeholder="Seu nome" class="appearance-none block w-full bg-gray-800 text-white border border-gray-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-gray-700">
                </div>
            </div>
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <input id="email" type="email" name="email" placeholder="Seu e-mail" class="appearance-none block w-full bg-gray-800 text-white border border-gray-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-gray-700">
                </div>
            </div>
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <textarea id="mensagem" name="mensagem" placeholder="Sua mensagem" rows="8" class="appearance-none block w-full bg-gray-800 text-white border border-gray-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-gray-700"></textarea>
                </div>
            </div>

            <div class="flex items-center justify-center mt-6">
                <button type="submit" class="inline-block px-6 py-3 text-base font-semibold text-white bg-green-700 rounded-full hover:bg-green-600">
                    ENVIAR MENSAGEM
                </button>
            </div>
        </form>
    ...
    <!-- Botão de WhatsApp -->
    <a href="https://api.whatsapp.com/send/?phone=35988545668&text&type=phone_number&app_absent=0" target="_blank" class="fixed right-4 bottom-4 z-50 bg-green-800 hover:bg-green-600 text-white p-4 rounded-full shadow-md transition duration-300 flex items-center justify-center" style="width: 50px; height: 50px;">
